...
public class GetFreeClassroomPostTask extends PostTask{
    public GetFreeClassroomPostTask(PerformanceTestManager manager) {
        super(manager);
    }
    @Override
    public RequestBuilder getRequest() {
        return MockMvcRequestBuilders.post("/getFreeClassroom")
